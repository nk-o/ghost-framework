...
(function () {
  ...
  function switchMode() {
    ...
    var isNight = !!ghostFrameworkNightMode.is_default_night;
    ...
    if (isNight) {
      ...
      localStorage.setItem(ghostFrameworkNightMode.night_class, 'night'); // Disable Night.
    } else {
  ...
  switchMode(false); // Click on switch button.
