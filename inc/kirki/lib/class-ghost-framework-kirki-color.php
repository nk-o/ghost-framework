<?php
/**
 * Color Calculations class for Ghost_Framework_Kirki
 * Initially built for the Shoestrap-3 theme and then tweaked for Ghost_Framework_Kirki.
 *
 ...
 */
final class Ghost_Framework_Kirki_Color extends ariColor {
