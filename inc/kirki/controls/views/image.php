...
data.choices.labels = _.defaults( data.choices.labels, {
    select: '<?php esc_html_e( 'Select image', '@@text_domain' ); ?>',
    change: '<?php esc_html_e( 'Change image', '@@text_domain' ); ?>',
    'default': '<?php esc_html_e( 'Default', '@@text_domain' ); ?>',
    remove: '<?php esc_html_e( 'Remove', '@@text_domain' ); ?>',
    placeholder: '<?php esc_html_e( 'No image selected', '@@text_domain' ); ?>',
    frame_title: '<?php esc_html_e( 'Select image', '@@text_domain' ); ?>',
    frame_button: '<?php esc_html_e( 'Choose image', '@@text_domain' ); ?>',
} );
#>
