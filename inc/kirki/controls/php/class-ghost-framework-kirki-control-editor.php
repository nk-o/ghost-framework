 ...
 * A TinyMCE control.
 */
class Ghost_Framework_Kirki_Control_Editor extends Ghost_Framework_Kirki_Control_Base {
     ...
     *
     * The actual editor is added from the Ghost_Framework_Kirki_Field_Editor class.
