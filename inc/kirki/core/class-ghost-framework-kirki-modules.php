...
/**
 * The Ghost_Framework_Kirki_Modules class.
 */
class Ghost_Framework_Kirki_Modules {
    ...
    public function setup_default_modules() {
        self::$modules = apply_filters(
            'kirki_modules',
            array(
                'css'                => 'Ghost_Framework_Kirki_Modules_CSS',
                'css-vars'           => 'Ghost_Framework_Kirki_Modules_CSS_Vars',
                'customizer-styling' => 'Ghost_Framework_Kirki_Modules_Customizer_Styling',
                'icons'              => 'Ghost_Framework_Kirki_Modules_Icons',
                'loading'            => 'Ghost_Framework_Kirki_Modules_Loading',
                'tooltips'           => 'Ghost_Framework_Kirki_Modules_Tooltips',
                'branding'           => 'Ghost_Framework_Kirki_Modules_Customizer_Branding',
                'postMessage'        => 'Ghost_Framework_Kirki_Modules_PostMessage',
                'selective-refresh'  => 'Ghost_Framework_Kirki_Modules_Selective_Refresh',
                'field-dependencies' => 'Ghost_Framework_Kirki_Modules_Field_Dependencies',
                'custom-sections'    => 'Ghost_Framework_Kirki_Modules_Custom_Sections',
                'preset'             => 'Ghost_Framework_Kirki_Modules_Preset',
            )
        );
    }
