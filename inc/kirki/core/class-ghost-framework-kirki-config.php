...
/**
 * The Ghost_Framework_Kirki_Config object
 */
final class Ghost_Framework_Kirki_Config {
    ...
    /**
     * Set to true if you want to completely disable any Ghost_Framework_Kirki-generated CSS.
     *
     * @access protected
     * @var bool
     */
     ...
     *
     * @access private
     * @param string $config_id @see Ghost_Framework_Kirki_Config::get_instance().
     * @param array  $args      @see Ghost_Framework_Kirki_Config::get_instance().
     */
     ...
     * }
     *
     * @return Ghost_Framework_Kirki_Config
     */
