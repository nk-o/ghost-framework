<?php
/**
 * Handles sections created via the Ghost_Framework_Kirki API.
 *
 ...
 */
class Ghost_Framework_Kirki_Settings {
    ...
    /**
     * Creates a new Ghost_Framework_Kirki_Settings object.
     * Class constructor.
     *
     * @access public
     * @param array $args The field definition as sanitized in Ghost_Framework_Kirki_Field.
     */
    ...
    private function set_setting_types() {
        ...
        $this->setting_types = apply_filters(
            ...
            array(
                ...
                'repeater'    => 'Ghost_Framework_Kirki_Settings_Repeater_Setting',
                'user_meta'   => 'Ghost_Framework_Kirki_Setting_User_Meta',
                'site_option' => 'Ghost_Framework_Kirki_Setting_Site_Option',
            )
        );
