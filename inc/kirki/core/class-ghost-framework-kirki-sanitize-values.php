 ...
 */
class Ghost_Framework_Kirki_Sanitize_Values {
     ...
     *
     * Deprecated. Use Ghost_Framework_Kirki_Field_Checkbox::sanitize() instead.
     *
     * @static
     * @access public
     * @see Ghost_Framework_Kirki_Field_Checkbox::sanitize()
     * @param bool|string $value Whether the checkbox is checked.
     * @return bool Whether the checkbox is checked.
     */
    public static function checkbox( $value ) {
        $obj = new Ghost_Framework_Kirki_Field_Checkbox();
