...
class Ghost_Framework_Kirki_Modules_CSS_Vars {
    ...
    public function postmessage() {
        wp_enqueue_script( 'kirki_auto_css_vars', trailingslashit( Ghost_Framework_Kirki::$url ) . 'modules/css-vars/script.js', array( 'jquery', 'customize-preview' ), KIRKI_VERSION, true );
        $fields = Ghost_Framework_Kirki::$fields;
        $data   = array();
