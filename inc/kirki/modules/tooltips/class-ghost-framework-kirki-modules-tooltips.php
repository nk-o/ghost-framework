 ...
 */
class Ghost_Framework_Kirki_Modules_Tooltips {
    ...
    public function customize_controls_print_footer_scripts() {
        ...
        wp_enqueue_script( 'kirki-tooltip', trailingslashit( Ghost_Framework_Kirki::$url ) . 'modules/tooltips/tooltip.min.js', array( 'jquery' ), '@@theme_version', false );
        wp_localize_script( 'kirki-tooltip', 'kirkiTooltips', $this->tooltips_content );
        wp_enqueue_style( 'kirki-tooltip', trailingslashit( Ghost_Framework_Kirki::$url ) . 'modules/tooltips/tooltip.min.css', array(), '@@theme_version' );
    }
}
