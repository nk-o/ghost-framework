...
class Ghost_Framework_Kirki_Modules_Field_Dependencies {
    ...
    public function field_dependencies() {
        wp_enqueue_script( 'kirki_field_dependencies', trailingslashit( Ghost_Framework_Kirki::$url ) . 'modules/field-dependencies/field-dependencies.js', array( 'jquery', 'customize-base', 'customize-controls' ), KIRKI_VERSION, true );
    }
}
