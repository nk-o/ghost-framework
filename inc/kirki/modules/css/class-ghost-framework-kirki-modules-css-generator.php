 ...
 * Handles CSS output.
 */
final class Ghost_Framework_Kirki_Modules_CSS_Generator {
    ...
    public static function css( $field ) {
        ...
        self::$value = Ghost_Framework_Kirki_Values::get_sanitized_field_value( $field );

        // Find the class that will handle the outpout for this field.
        $classname            = 'Ghost_Framework_Kirki_Output';
        $default_classnames   = array(
            'kirki-image'      => 'Ghost_Framework_Kirki_Output_Field_Image',
        );
