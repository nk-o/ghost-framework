 ...
 */
class Ghost_Framework_Kirki_Output {

    /**
     * The Ghost_Framework_Kirki configuration used in the field.
     *
     * @access protected
     * @var string
     */
    ...
    protected function apply_pattern_replace( $output, $value ) {
        if ( isset( $output['pattern_replace'] ) && is_array( $output['pattern_replace'] ) ) {
            $option_type = ( '' !== Ghost_Framework_Kirki::get_config_param( $this->config_id, 'option_type' ) ) ? Ghost_Framework_Kirki::get_config_param( $this->config_id, 'option_type' ) : 'theme_mod';
            $option_name = Ghost_Framework_Kirki::get_config_param( $this->config_id, 'option_name' );
            $options     = array();
            if ( $option_name ) {
            ...
            foreach ( $output['pattern_replace'] as $search => $replace ) {
                ...
                switch ( $option_type ) {
                    ...
                    default:
                        ...
                        if ( ! $replacement ) {
                            $replacement = Ghost_Framework_Kirki_Values::get_value( $this->field['kirki_config'], $replace );
                        }
                }
    ...
    protected function process_property_value( $property, $value ) {
        $properties = apply_filters(
            ...
            array(
                'background-image'    => 'Ghost_Framework_Kirki_Output_Property_Background_Image',
                'background-position' => 'Ghost_Framework_Kirki_Output_Property_Background_Position',
            )
        );
