...
/**
 * The Ghost_Framework_Kirki_Modules_CSS object.
 */
class Ghost_Framework_Kirki_Modules_CSS {
    ...
    protected function __construct() {
        $class_files = array(
            'Ghost_Framework_Kirki_Modules_CSS_Generator'               => '/class-ghost-framework-kirki-modules-css-generator.php',
            'Ghost_Framework_Kirki_Output'                              => '/class-ghost-framework-kirki-output.php',
            'Ghost_Framework_Kirki_Output_Field_Background'             => '/field/class-ghost-framework-kirki-output-field-background.php',
            'Ghost_Framework_Kirki_Output_Field_Image'                  => '/field/class-ghost-framework-kirki-output-field-image.php',
            'Ghost_Framework_Kirki_Output_Property'                     => '/property/class-ghost-framework-kirki-output-property.php',
            'Ghost_Framework_Kirki_Output_Property_Background_Image'    => '/property/class-ghost-framework-kirki-output-property-background-image.php',
            'Ghost_Framework_Kirki_Output_Property_Background_Position' => '/property/class-ghost-framework-kirki-output-property-background-position.php',
        );
    ...
    public function init() {
        ...
        // Allow completely disabling Ghost_Framework_Kirki CSS output.
    ...
    public function print_styles() {
        ...
        $configs = Ghost_Framework_Kirki::$config;
    ...
    public static function loop_controls( $config_id ) {
        ...
        // Get an instance of the Ghost_Framework_Kirki_Modules_CSS_Generator class.
        // This will make sure google fonts and backup fonts are loaded.
        // Ghost_Framework_Kirki_Modules_CSS_Generator::get_instance().
        ...
        foreach ( $fields as $field ) {
                ...
                if ( ! empty( $field['required'] ) ) {
                    ...
                    foreach ( $field['required'] as $requirement ) {
                        if ( isset( $requirement['setting'] ) && isset( $requirement['value'] ) && isset( $requirement['operator'] ) ) {
                            $controller_value = Ghost_Framework_Kirki_Values::get_value( $config_id, $requirement['setting'] );
                            if ( ! Ghost_Framework_Kirki_Helper::compare_values( $controller_value, $requirement['value'], $requirement['operator'] ) ) {
                                $valid = false;
                            }
                        }
                    }
            ...
            if ( isset( $field['output'] ) && ! empty( $field['output'] ) ) {
                $css = Ghost_Framework_Kirki_Helper::array_replace_recursive( $css, Ghost_Framework_Kirki_Modules_CSS_Generator::css( $field ) );

                // Add the globals.
                if ( isset( self::$css_array[ $config_id ] ) && ! empty( self::$css_array[ $config_id ] ) ) {
                    Ghost_Framework_Kirki_Helper::array_replace_recursive( $css, self::$css_array[ $config_id ] );
                }
            }
        }
        ...
        if ( is_array( $css ) ) {
            return Ghost_Framework_Kirki_Modules_CSS_Generator::styles_parse( Ghost_Framework_Kirki_Modules_CSS_Generator::add_prefixes( $css ) );
        }
    }
