 ...
 * Field overrides.
 */
class Ghost_Framework_Kirki_Field_FontAwesome extends Ghost_Framework_Kirki_Field_Select {
    ...
    protected function set_choices() {
        ob_start();
        $json_path = wp_normalize_path( Ghost_Framework_Kirki::$path . '/assets/vendor/fontawesome/fontawesome.json' );
