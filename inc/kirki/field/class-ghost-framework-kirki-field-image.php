 ...
 * Field overrides.
 */
class Ghost_Framework_Kirki_Field_Image extends Ghost_Framework_Kirki_Field {
    ...
    protected function set_button_labels() {
        $this->button_labels = wp_parse_args(
            $this->button_labels,
            array(
                'select'       => esc_html__( 'Select image', '@@text_domain' ),
                'change'       => esc_html__( 'Change image', '@@text_domain' ),
                'default'      => esc_html__( 'Default', '@@text_domain' ),
                'remove'       => esc_html__( 'Remove', '@@text_domain' ),
                'placeholder'  => esc_html__( 'No image selected', '@@text_domain' ),
                'frame_title'  => esc_html__( 'Select image', '@@text_domain' ),
                'frame_button' => esc_html__( 'Choose image', '@@text_domain' ),
            )
        );
    }
