 ...
 * Field overrides.
 */
class Ghost_Framework_Kirki_Field_Color extends Ghost_Framework_Kirki_Field {
    ...
    protected function set_choices() {
        ...
        if ( true === $this->alpha ) {
            _doing_it_wrong( 'Ghost_Framework_Kirki::add_field', esc_html__( 'Do not use "alpha" as an argument in color controls. Use "choices[alpha]" instead.', '@@text_domain' ), '3.0.10' );
    ...
    protected function set_sanitize_callback() {
        ...
        $this->sanitize_callback = array( 'Ghost_Framework_Kirki_Sanitize_Values', 'color' );
    }
}
