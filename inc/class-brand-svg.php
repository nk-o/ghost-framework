...
class Ghost_Framework_Brand_Svg {
    ...
    public static function get_all_brands( $get_svg = false, $svg_data = array() ) {
        $brands = array(
            ...
            'bluesky'                   => esc_html__( 'Bluesky', '@@text_domain' ),
            ...
            'dart-lang'                 => esc_html__( 'Dart', '@@text_domain' ),
            ...
            'flutter'                   => esc_html__( 'Flutter', '@@text_domain' ),
            ...
            'hooli'                     => esc_html__( 'Hooli', '@@text_domain' ),
            ...
            'jxl'                       => esc_html__( 'JXL', '@@text_domain' ),
            ...
            'pied-piper'                => esc_html__( 'Pied Piper', '@@text_domain' ),
            ...
            'shoelace'                  => esc_html__( 'Shoelace', '@@text_domain' ),
            'shopify'                   => esc_html__( 'Shopify', '@@text_domain' ),
            'shopware'                  => esc_html__( 'Shopware', '@@text_domain' ),
            'signal-messenger'          => esc_html__( 'Signal Messenger', '@@text_domain' ),
            ...
            'space-awesome'             => esc_html__( 'Space Awesome', '@@text_domain' ),
            ...
            'web-awesome'               => esc_html__( 'Web Awesome', '@@text_domain' ),
            'webflow'                   => esc_html__( 'Webflow', '@@text_domain' ),
            'wechat'                    => array(
